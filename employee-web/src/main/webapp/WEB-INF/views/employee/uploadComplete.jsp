...
<body>
	<div id="wrapper">
        ...
        Download ${f:h(uploadFileInfoList.description)} : <a
				target="${uploadFileInfoList.fileId}"
				href="${pageContext.request.contextPath}/download/tmp/${f:u(uploadFileInfoList.fileId)}">${f:h(uploadFileInfoList.fileName)}</a>
